...
def init_seeds(seed=0, deterministic=False):
    ...
    if deterministic and check_version(torch.__version__, "1.12.0"):  # https://github.com/ultralytics/yolov5/pull/8213
        # Some CUDA ops (e.g. adaptive_max_pool2d backward in CBAM) have no deterministic implementation.
        # Use warn_only to keep reproducibility constraints as much as possible without hard-crashing training.
        try:
