...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, eps=1e-7):
    """Calculates IoU, GIoU, DIoU, CIoU, or SIoU between two boxes, supporting xywh/xyxy formats.
    ...
    if CIoU or DIoU or GIoU or SIoU:
        ...
        if SIoU:  # SIoU loss https://arxiv.org/abs/2205.12740
            ...
            angle_cost = torch.cos(torch.asin(sin_alpha).clamp(0, math.pi / 2) * 2 - math.pi / 2)
