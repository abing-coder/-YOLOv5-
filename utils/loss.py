    ...
    def __call__(self, p, targets):  # predictions, targets
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n := b.shape[0]:
                ...
                # iou = bbox_iou(pbox, tbox[i], CIoU=True).squeeze()  # CIoU baseline for ablation
                iou = bbox_iou(pbox, tbox[i], SIoU=True).squeeze()  # SIoU for elongated/complex defect localization
